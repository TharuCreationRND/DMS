...
urlpatterns = [
    ...
    path('upload-classchange-excel/', views.upload_classchange_excel, name='upload_classchange_excel'),
    path('class-change-list/', views.class_change_list, name='class_change_list'),
